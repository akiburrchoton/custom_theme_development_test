<?php
/**
 * ABC Insurance functions and definitions
 *
...
if ( ! function_exists( 'abcinsurance_setup' ) ) :
	/**
	 ...
	 */
	function abcinsurance_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on ABC Insurance, use a find and replace
		 * to change 'abcinsurance' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'abcinsurance', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'abcinsurance_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'abcinsurance_setup' );
 ...
 */
function abcinsurance_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'abcinsurance_content_width', 640 );
}
add_action( 'after_setup_theme', 'abcinsurance_content_width', 0 );
 ...
 */
function abcinsurance_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'abcinsurance' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'abcinsurance' ),
...
add_action( 'widgets_init', 'abcinsurance_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'abcinsurance_scripts' );
